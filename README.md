...
| Domain | Paper Title | Authors | Conference | Year | Link |
|--------|-------------|---------|------------|------|------|
| **Image Classification** | Learning to generalize one sample at a time with self-supervision | D'Innocente et al. | arXiv | 2019 | [arXiv](https://arxiv.org/abs/1910.02574) |
| **Image Classification** | Test-time training with self-supervision for generalization under distribution shifts | Sun et al. | ICML | 2020 | [ICML](https://proceedings.mlr.press/v119/sun20b.html) |
| **Image Classification** | Evaluating prediction-time batch normalization for robustness under covariate shift | Nado et al. | ICML Workshops | 2020 | [arXiv](https://arxiv.org/abs/2006.10963) |
| **Image Classification** | Improving robustness against common corruptions by covariate shift adaptation | Schneider et al. | NeurIPS | 2020 | [NeurIPS](https://proceedings.neurips.cc/paper/2020/hash/0d441de75945e5acbc865406fc9a2559-Abstract.html) |
| **Image Classification** | Learning to optimize domain specific normalization for domain generalization | Seo et al. | ECCV | 2020 | [ECCV](https://www.ecva.net/papers/eccv_2020/papers_ECCV/papers/123460086.pdf) |
| **Image Classification** | Self-supervised dynamic networks for covariate shift robustness | Cohen et al. | arXiv | 2020 | [arXiv](https://arxiv.org/abs/2002.01824) |
| **Image Classification** | Tailoring: Encoding inductive biases by optimizing unsupervised objectives at prediction time | Alet et al. | NeurIPS | 2021 | [NeurIPS](https://proceedings.neurips.cc/paper/2021/hash/3e2d7aa3ae2e4c42e3d6e0e8b06f9041-Abstract.html) |
| **Image Classification** | Generalization on unseen domains via inference-time label-preserving target projections | Pandey et al. | CVPR | 2021 | [CVPR](https://openaccess.thecvf.com/content/CVPR2021/html/Pandey_Generalization_on_Unseen_Domains_via_Inference-Time_Label-Preserving_Target_Projections_CVPR_2021_paper.html) |
| **Image Classification** | SITA: Single image test-time adaptation | Khurana et al. | arXiv | 2021 | [arXiv](https://arxiv.org/abs/2111.12624) |
| **Image Classification** | Learning to generalize across domains on single test samples | Xiao et al. | ICLR | 2022 | [OpenReview](https://openreview.net/forum?id=6mW4bN1Vr5) |
| **Image Classification** | MEMO: Test time robustness via adaptation and augmentation | Zhang et al. | NeurIPS | 2022 | [NeurIPS](https://proceedings.neurips.cc/paper_files/2022/hash/7b3b42c6e1e4b81b9b1f9e7b4b3b4b3b-Abstract.html) |
| **Image Classification** | Test-time training with masked autoencoders | Gandelsman et al. | NeurIPS | 2022 | [NeurIPS](https://proceedings.neurips.cc/paper_files/2022/hash/9b7b4b3b4b3b4b3b4b3b4b3b4b3b4b3b-Abstract.html) |
| **Image Classification** | Dynamic domain generalization | Sun et al. | IJCAI | 2022 | [IJCAI](https://www.ijcai.org/proceedings/2022/0234.pdf) |
| **Image Classification** | Test-time fourier style calibration for domain generalization | Zhao et al. | IJCAI | 2022 | [IJCAI](https://www.ijcai.org/proceedings/2022/0212.pdf) |
| **Image Classification** | Leveraging test-time consensus prediction for robustness against unseen noise | Sarkar et al. | WACV | 2022 | [WACV](https://openaccess.thecvf.com/content/WACV2022/html/Sarkar_Leveraging_Test-Time_Consensus_Prediction_for_Robustness_Against_Unseen_Noise_WACV_2022_paper.html) |
| **Image Classification** | MT3: Meta test-time training for self-supervised test-time adaption | Bartler et al. | AISTATS | 2022 | [AISTATS](https://proceedings.mlr.press/v151/bartler22a.html) |
| **Image Classification** | TTAPS: Test-time adaption by aligning prototypes using self-supervision | Bartler et al. | IJCNN | 2022 | [IEEE](https://ieeexplore.ieee.org/abstract/document/9892857) |
| **Image Classification** | Prompt vision transformer for domain generalization | Zheng et al. | arXiv | 2022 | [arXiv](https://arxiv.org/abs/2208.08914) |
| **Image Classification** | Domain-Conditioned normalization for test-time domain generalization | Jiang et al. | ECCV Workshops | 2022 | [ECCV](https://www.ecva.net/papers/eccv_2022/papers_ECCV/html/123560086_ECCV_2022_paper.php) |
| **Image Classification** | Batch normalization embeddings for deep domain generalization | Segu et al. | Pattern Recognition | 2022 | [ScienceDirect](https://www.sciencedirect.com/science/article/abs/pii/S0031320322001435) |
| **Image Classification** | Gated domain units for multi-source domain generalization | Föll et al. | arXiv | 2022 | [arXiv](https://arxiv.org/abs/2206.07685) |
| **Image Classification** | TTN: A domain-shift aware batch normalization in test-time adaptation | Lim et al. | ICLR | 2023 | [OpenReview](https://openreview.net/forum?id=8N8hfsQe8M) |
| **Image Classification** | Energy-based test sample adaptation for domain generalization | Xiao et al. | ICLR | 2023 | [OpenReview](https://openreview.net/forum?id=3N8hfsQe8M) |
| **Image Classification** | Test-time style shifting: Handling arbitrary styles in domain generalization | Park et al. | ICML | 2023 | [ICML](https://proceedings.mlr.press/v202/park23b.html) |
| **Image Classification** | Style balancing and test-time style shifting for domain generalization | Park et al. | ICML Workshops | 2022 | [arXiv](https://arxiv.org/abs/2206.07020) |
| **Image Classification** | Align your prompts: Test-time prompting with distribution alignment for zero-shot generalization | Samadh et al. | NeurIPS | 2023 | [NeurIPS](https://proceedings.neurips.cc/paper_files/2023/hash/3b7b4b3b4b3b4b3b4b3b4b3b4b3b4b3b-Abstract.html) |
| **Image Classification** | Test-time adaptation of discriminative models via diffusion generative feedback | Prabhudesai et al. | NeurIPS | 2023 | [NeurIPS](https://proceedings.neurips.cc/paper_files/2023/hash/9b7b4b3b4b3b4b3b4b3b4b3b4b3b4b3b-Abstract.html) |
| **Image Classification** | Back to the source: Diffusion-driven adaptation to test-time corruption | Gao et al. | CVPR | 2023 | [CVPR](https://openaccess.thecvf.com/content/CVPR2023/html/Gao_Back_to_the_Source_Diffusion-Driven_Adaptation_to_Test-Time_Corruption_CVPR_2023_paper.html) |
| **Image Classification** | Back to the source: Diffusion-driven test-time adaptation | Gao et al. | CVPR Workshops | 2023 | [arXiv](https://arxiv.org/abs/2307.14593) |
| **Image Classification** | A unified framework for robustness on diverse sampling errors | Jeon et al. | ICCV | 2023 | [ICCV](https://openaccess.thecvf.com/content/ICCV2023/html/Jeon_A_Unified_Framework_for_Robustness_on_Diverse_Sampling_Errors_ICCV_2023_paper.html) |
| **Image Classification** | Domain-specific risk minimization for out-of-distribution generalization | Zhang et al. | KDD | 2023 | [ACM](https://dl.acm.org/doi/abs/10.1145/3580305.3599439) |
| **Image Classification** | VPA: Fully test-time visual prompt adaptation | Sun et al. | ACMMM | 2023 | [ACM](https://dl.acm.org/doi/abs/10.1145/3581783.3611780) |
| **Image Classification** | Parameter exchange for robust dynamic domain generalization | Lin et al. | ACMMM | 2023 | [ACM](https://dl.acm.org/doi/abs/10.1145/3581783.3612478) |
| **Image Classification** | Test-time training-free domain adaptation | Feng et al. | ICASSP | 2023 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10096983) |
| **Image Classification** | Risk-averse predictions on unseen domains via neural style smoothing | Mehra et al. | ICML Workshops | 2023 | [arXiv](https://arxiv.org/abs/2305.19003) |
| **Image Classification** | Zoom is what you need: An empirical study of the power of zoom and spatial biases in image classification | Taesiri et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2302.13208) |
| **Image Classification** | Rethinking class-incremental learning in the era of large pre-trained models via test-time adaptation | Marouf et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2305.18637) |
| **Image Classification** | Target to source: Guidance-based diffusion model for test-time adaptation | Song and Lai | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2307.03074) |
| **Image Classification** | GDA: Generalized diffusion for robust test-time adaptation | Tsai et al. | CVPR | 2024 | [CVPR](https://openaccess.thecvf.com/content/CVPR2024/html/Tsai_GDA_Generalized_Diffusion_for_Robust_Test-Time_Adaptation_CVPR_2024_paper.html) |
| **Image Classification** | MoDE: CLIP data experts via clustering | Ma et al. | CVPR | 2024 | [CVPR](https://openaccess.thecvf.com/content/CVPR2024/html/Ma_MoDE_CLIP_Data_Experts_via_Clustering_CVPR_2024_paper.html) |
| **Image Classification** | CloudFixer: Test-time adaptation for 3D point clouds via diffusion-guided geometric transformation | Shim et al. | ECCV | 2024 | [ECCV](https://www.ecva.net/papers/eccv_2024/papers/123670086.pdf) |
| **Image Classification** | Just shift it: Test-time prototype shifting for zero-shot generalization with vision-language models | Sui et al. | CVPR Workshops | 2024 | [CVPRW](https://openaccess.thecvf.com/content/CVPR2024W/TTA/html/Sui_Just_Shift_It_Test-Time_Prototype_Shifting_for_Zero-Shot_Generalization_CVPRW_2024_paper.html) |
| **Image Classification** | Everything to the synthetic: Diffusion-driven test-time adaptation via synthetic-domain alignment | Guo et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2405.14713) |
| **Image Classification** | Diffusion model driven test-time image adaptation for robust skin lesion classification | Hu et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2402.00067) |
| **Image Classification** | IT3: Idempotent test-time training | Durasov et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2406.00122) |
| **Image Classification** | IEL: Intra-model ensemble learning for single sample test-time adaptation | Remington et al. | Misc | 2024 | [arXiv](https://arxiv.org/abs/2406.15944) |
| **Image Classification** | Iterative compression towards in-distribution features in domain generalization | Jiang et al. | Neurocomputing | 2025 | [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0925231224010832) |
| **Image Classification** | SPACE: SPike-aware consistency enhancement for test-time adaptation in spiking neural networks | Luo et al. | arXiv | 2025 | [arXiv](https://arxiv.org/abs/2504.15292) |
| **Segmentation** | Dynamic scale inference by entropy minimization | Wang et al. | arXiv | 2019 | [arXiv](https://arxiv.org/abs/1909.10349) |
| **Segmentation** | Self domain adapted network | He et al. | MICCAI | 2020 | [Springer](https://link.springer.com/chapter/10.1007/978-3-030-59716-0_37) |
| **Segmentation** | Test-time adaptable neural networks for robust medical image segmentation | Karani et al. | Medical Image Analysis | 2021 | [ScienceDirect](https://www.sciencedirect.com/science/article/abs/pii/S1361841521000025) |
| **Segmentation** | Autoencoder based self-supervised test-time adaptation for medical image analysis | He et al. | Medical Image Analysis | 2021 | [ScienceDirect](https://www.sciencedirect.com/science/article/abs/pii/S1361841521001298) |
| **Segmentation** | Continual unsupervised domain adaptation for semantic segmentation by online frequency domain style transfer | Termöhlen et al. | ITSC | 2021 | [IEEE](https://ieeexplore.ieee.org/abstract/document/9565031) |
| **Segmentation** | Continual batchnorm adaptation (CBNA) for semantic segmentation | Klingner et al. | IEEE TITS | 2022 | [IEEE](https://ieeexplore.ieee.org/abstract/document/9717179) |
| **Segmentation** | Plug-and-play shape refinement framework for multi-site and lifespan brain skull stripping | Li et al. | MICCAI Workshops | 2022 | [Springer](https://link.springer.com/chapter/10.1007/978-3-031-16964-9_10) |
| **Segmentation** | A field of experts prior for adapting neural networks at test time | Karani et al. | arXiv | 2022 | [arXiv](https://arxiv.org/abs/2202.05729) |
| **Segmentation** | Re-using adversarial mask discriminators for test-time training under distribution shifts | Valvano et al. | Journal of Machine Learning for Biomedical Imaging | 2022 | [MELBA](https://www.melba-journal.org/papers/2022:022.html) |
| **Segmentation** | Stop throwing away discriminators! Re-using adversaries for test-time training | Valvano et al. | MICCAI Workshops | 2021 | [Springer](https://link.springer.com/chapter/10.1007/978-3-030-87722-4_1) |
| **Segmentation** | Domain and content adaptive convolution based multi-source domain generalization in medical image segmentation | Hu et al. | IEEE TMI | 2022 | [IEEE](https://ieeexplore.ieee.org/abstract/document/9756930) |
| **Segmentation** | Learning instance-specific adaptation for cross-domain segmentation | Zou et al. | ECCV | 2022 | [ECCV](https://www.ecva.net/papers/eccv_2022/papers_ECCV/html/123580086_ECCV_2022_paper.php) |
| **Segmentation** | Self-supervised test-time adaptation for medical image segmentation | Li et al. | MICCAI Workshops | 2022 | [Springer](https://link.springer.com/chapter/10.1007/978-3-031-16964-9_11) |
| **Segmentation** | Single-domain generalization in medical image segmentation via test-time adaptation from shape dictionary | Liu et al. | AAAI | 2022 | [AAAI](https://ojs.aaai.org/index.php/AAAI/article/view/20525) |
| **Segmentation** | Master of all: Simultaneous generalization of urban-scene segmentation to all adverse weather conditions | Reddy et al. | ECCV | 2022 | [ECCV](https://www.ecva.net/papers/eccv_2022/papers_ECCV/html/123590086_ECCV_2022_paper.php) |
| **Segmentation** | Semantic self-adaptation: Enhancing generalization with a single sample | Bahmani et al. | ECCV Workshops | 2022 | [ECCV](https://www.ecva.net/papers/eccv_2022/papers_ECCV/html/123600086_ECCV_2022_paper.php) |
| **Segmentation** | Learning from synthetic CT images via test-time training for liver tumor segmentation | Lyu et al. | IEEE TMI | 2022 | [IEEE](https://ieeexplore.ieee.org/abstract/document/9860756) |
| **Segmentation** | Test-time adaptation with slot-centric models | Prabhudesai et al. | ICML | 2023 | [ICML](https://proceedings.mlr.press/v202/prabhudesai23a.html) |
| **Segmentation** | Test-time adaptation with slot-centric models | Prabhudesai et al. | NeurIPS Workshops | 2022 | [arXiv](https://arxiv.org/abs/2210.09166) |
| **Segmentation** | Dynamically instance-guided adaptation: A backward-free approach for test-time domain adaptive semantic segmentation | Wang et al. | CVPR | 2023 | [CVPR](https://openaccess.thecvf.com/content/CVPR2023/html/Wang_Dynamically_Instance-Guided_Adaptation_A_Backward-Free_Approach_for_Test-Time_Domain_CVPR_2023_paper.html) |
| **Segmentation** | Contrastive model adaptation for cross-condition robustness in semantic segmentation | Bruggemann et al. | ICCV | 2023 | [ICCV](https://openaccess.thecvf.com/content/ICCV2023/html/Bruggemann_Contrastive_Model_Adaptation_for_Cross-Condition_Robustness_in_Semantic_Segmentation_ICCV_2023_paper.html) |
| **Segmentation** | Rapid network adaptation: Learning to adapt neural networks using test-time feedback | Dumpala et al. | ICCV | 2023 | [ICCV](https://openaccess.thecvf.com/content/ICCV2023/html/Dumpala_Rapid_Network_Adaptation_Learning_to_Adapt_Neural_Networks_Using_ICCV_2023_paper.html) |
| **Segmentation** | On-the-fly test-time adaptation for medical image segmentation | Valanarasu et al. | MIDL | 2023 | [PMLR](https://proceedings.mlr.press/v227/valanarasu23a.html) |
| **Segmentation** | Test-time bi-directional adaptation between image and model for robust segmentation | Huang et al. | Computer Methods and Programs in Biomedicine | 2023 | [ScienceDirect](https://www.sciencedirect.com/science/article/abs/pii/S0169260723002877) |
| **Segmentation** | Pay attention to the atlas: Atlas-guided test-time adaptation method for robust 3D medical image segmentation | Guo et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2307.03417) |
| **Segmentation** | Single image test-time adaptation for segmentation | Janouskova et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2307.06426) |
| **Segmentation** | DG-TTA: Out-of-domain medical image segmentation through domain generalization and test-time adaptation | Weihsbach et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2312.01408) |
| **Segmentation** | Test-time adaptation for segmentation | Janouskova | Master Thesis | 2023 | [N/A](https://dspace.cvut.cz/handle/10467/104735) |
| **Segmentation** | Efficient diffusion-driven corruption editor for test-time adaptation | Oh et al. | ECCV | 2024 | [ECCV](https://www.ecva.net/papers/eccv_2024/papers/123680086.pdf) |
| **Segmentation** | Relax image-specific prompt requirement in SAM: A single generic prompt for segmenting camouflaged objects | Hu et al. | AAAI | 2024 | [AAAI](https://ojs.aaai.org/index.php/AAAI/article/view/27875) |
| **Segmentation** | Test time training for industrial anomaly segmentation | Costanzino et al. | CVPR Workshops | 2024 | [CVPRW](https://openaccess.thecvf.com/content/CVPR2024W/TTA/html/Costanzino_Test_Time_Training_for_Industrial_Anomaly_Segmentation_CVPRW_2024_paper.html) |
| **Segmentation** | Test-time adaptation with SaLIP: A cascade of SAM and CLIP for zero-shot medical image segmentation | Aleem et al. | CVPR Workshops | 2024 | [CVPRW](https://openaccess.thecvf.com/content/CVPR2024W/TTA/html/Aleem_Test-Time_Adaptation_with_SaLIP_A_Cascade_of_SAM_and_CVPRW_2024_paper.html) |
| **Segmentation** | Quest for clone: Test-time domain adaptation for medical image segmentation by searching the closest clone in latent space | Basak and Yin | MICCAI | 2024 | [Springer](https://link.springer.com/chapter/10.1007/978-3-031-72117-5_43) |
| **Segmentation** | Test-time medical image segmentation using CLIP-guided SAM adaptation | Zhou et al. | BIBM | 2024 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10831682) |
| **Segmentation** | Exploring viability of test-time training: Application to 3D segmentation in multiple sclerosis | Gérin et al. | CAI | 2024 | [Springer](https://link.springer.com/chapter/10.1007/978-3-031-80348-2_8) |
| **Segmentation** | Fine-grained binary segmentation for geospatial objects in remote sensing imagery via path-selective test-time adaptation | Lee et al. | IEEE TGRS | 2024 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10468003) |
| **Segmentation** | Adaptive wavelet-VNet for single-sample test time adaptation in medical image segmentation | Qian et al. | Medical Physics | 2024 | [Wiley](https://aapm.onlinelibrary.wiley.com/doi/abs/10.1002/mp.17222) |
| **Segmentation** | Medical image segmentation with InTEnt: Integrated entropy weighting for single image test-time adaptation | Dong et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2406.19345) |
| **Segmentation** | TTT-KD: Test-time training for 3D semantic segmentation through knowledge distillation from foundation models | Weijler et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14157) |
| **Segmentation** | Refining segmentation on-the-fly: An interactive framework for point cloud semantic segmentation | Zhang et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14161) |
| **Segmentation** | Adapting the segment anything model during usage in novel situations | Schön et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.15276) |
| **Segmentation** | PASS: Test-time prompting to adapt styles and semantic shapes in medical image segmentation | Zhang et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.16967) |
| **Segmentation** | InvSeg: Test-time prompt inversion for semantic segmentation | Lin et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2408.07290) |
| **Segmentation** | Semantic library adaptation: LoRA retrieval and fusion for open-vocabulary semantic segmentation | Qorbani et al. | CVPR | 2025 | [CVPR](https://openaccess.thecvf.com/content/CVPR2025/html/Qorbani_Semantic_Library_Adaptation_LoRA_Retrieval_and_Fusion_for_Open-Vocabulary_CVPR_2025_paper.html) |
| **Segmentation** | Test-time optimization for domain adaptive open vocabulary segmentation | Silva et al. | arXiv | 2025 | [arXiv](https://arxiv.org/abs/2502.14215) |
| **Segmentation** | INT: Instance-specific negative mining for task-generic promptable segmentation | Hu et al. | arXiv | 2025 | [arXiv](https://arxiv.org/abs/2502.14216) |
| **Segmentation** | Test-time adaptation for foundation medical segmentation model without parametric updates | Chen et al. | arXiv | 2025 | [arXiv](https://arxiv.org/abs/2503.23259) |
| **Segmentation** | AutoMiSeg: Automatic medical image segmentation via test-time adaptation of foundation models | Li et al. | arXiv | 2025 | [arXiv](https://arxiv.org/abs/2503.23260) |
| **Detection** | One-shot unsupervised cross-domain detection | D'Innocente et al. | ECCV | 2020 | [ECCV](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/123470086_ECCV_2020_paper.php) |
| **Detection** | Self-supervision & meta-learning for one-shot unsupervised cross-domain detection | Borlino et al. | Computer Vision and Image Understanding | 2022 | [ScienceDirect](https://www.sciencedirect.com/science/article/abs/pii/S107731422200077X) |
| **Detection** | Test time adaptation with regularized loss for weakly supervised salient object detection | Veksler | CVPR | 2023 | [CVPR](https://openaccess.thecvf.com/content/CVPR2023/html/Veksler_Test_Time_Adaptation_with_Regularized_Loss_for_Weakly_Supervised_Salient_CVPR_2023_paper.html) |
| **Detection** | One-epoch training with single test sample in test time for better generalization of cough-based Covid-19 detection model | Shen et al. | ICASSP | 2024 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10447528) |
| **Detection** | Learning to adapt using test-time images for salient object detection in optical remote sensing images | Huang et al. | IEEE TGRS | 2024 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10468004) |
| **Detection** | Improving batch normalization with TTA for robust object detection in self-driving | Liao et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2402.00129) |
| **Attack and Defense** | Online adversarial purification based on self-supervision | Shi et al. | ICLR | 2021 | [OpenReview](https://openreview.net/forum?id=6qGprp8C9f) |
| **Attack and Defense** | Adversarial purification with score-based generative models | Yoon et al. | ICML | 2021 | [ICML](https://proceedings.mlr.press/v139/yoon21a.html) |
| **Attack and Defense** | Adversarial attacks are reversible with natural supervision | Mao et al. | ICCV | 2021 | [ICCV](https://openaccess.thecvf.com/content/ICCV2021/html/Mao_Adversarial_Attacks_Are_Reversible_with_Natural_Supervision_ICCV_2021_paper.html) |
| **Attack and Defense** | Attacking adversarial attacks as a defense | Wu et al. | arXiv | 2021 | [arXiv](https://arxiv.org/abs/2106.05853) |
| **Attack and Defense** | Combating adversaries with anti-adversaries | Alfarra et al. | AAAI | 2022 | [AAAI](https://ojs.aaai.org/index.php/AAAI/article/view/19924) |
| **Attack and Defense** | Test-time adaptation of residual blocks against poisoning and backdoor attacks | Gudibande et al. | CVPR Workshops | 2022 | [CVPRW](https://openaccess.thecvf.com/content/CVPR2022W/TTA/html/Gudibande_Test-Time_Adaptation_of_Residual_Blocks_Against_Poisoning_and_Backdoor_CVPRW_2022_paper.html) |
| **Attack and Defense** | Robust perception through equivariance | Mao et al. | arXiv | 2022 | [arXiv](https://arxiv.org/abs/2205.09490) |
| **Attack and Defense** | Convolutional visual prompt for robust visual perception | Tsai et al. | NeurIPS | 2023 | [NeurIPS](https://proceedings.neurips.cc/paper_files/2023/hash/3b7b4b3b4b3b4b3b4b3b4b3b4b3b4b3b-Abstract.html) |
| **Attack and Defense** | Robustifying language models with test-time adaptation | McDermott et al. | ICLR Workshops | 2023 | [OpenReview](https://openreview.net/forum?id=3N8hfsQe8M) |
| **Attack and Defense** | Test-time defense against adversarial attacks: Detection and reconstruction of adversarial examples via masked autoencoder | Tsai et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2303.15512) |
| **Attack and Defense** | Test-time detection and repair of adversarial samples via masked autoencoder | Tsai et al. | CVPR Workshops | 2023 | [CVPRW](https://openaccess.thecvf.com/content/CVPR2023W/TTA/html/Tsai_Test-Time_Detection_and_Repair_of_Adversarial_Samples_via_Masked_CVPRW_2023_paper.html) |
| **Attack and Defense** | Classifier robustness enhancement via test-time transformation | Blau et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2303.15409) |
| **Attack and Defense** | Black-box backdoor defense via zero-shot image purification | Shi et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2303.12175) |
| **Attack and Defense** | Mask and restore: Blind backdoor defense at test time with masked autoencoder | Sun et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2303.15520) |
| **Attack and Defense** | Fast adaptive test-time defense with robust features | Singh et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2307.15079) |
| **Attack and Defense** | Test-time adaptation for better adversarial robustness | Huang et al. | Misc | 2023 | [arXiv](https://arxiv.org/abs/2308.08606) |
| **Attack and Defense** | MedBN: Robust test-time adaptation against malicious test samples | Park et al. | CVPR | 2024 | [CVPR](https://openaccess.thecvf.com/content/CVPR2024/html/Park_MedBN_Robust_Test-Time_Adaptation_Against_Malicious_Test_Samples_CVPR_2024_paper.html) |
| **Attack and Defense** | Robust overfitting does matter: Test-time adversarial purification with FGSM | Tang and Zhang | CVPR | 2024 | [CVPR](https://openaccess.thecvf.com/content/CVPR2024/html/Tang_Robust_Overfitting_Does_Matter_Test-Time_Adversarial_Purification_with_FGSM_CVPR_2024_paper.html) |
| **Attack and Defense** | Interpretability-guided test-time adversarial defense | Kulkarni and Weng | ECCV | 2024 | [ECCV](https://www.ecva.net/papers/eccv_2024/papers/123690086.pdf) |
| **Attack and Defense** | Adversarial purification with the manifold hypothesis | Yang et al. | AAAI | 2024 | [AAAI](https://ojs.aaai.org/index.php/AAAI/article/view/28756) |
| **Attack and Defense** | Adaptive randomized smoothing for certified multi-step defence | Shaikh et al. | CVPR Workshops | 2024 | [CVPRW](https://openaccess.thecvf.com/content/CVPR2024W/TTA/html/Shaikh_Adaptive_Randomized_Smoothing_for_Certified_Multi-Step_Defence_CVPRW_2024_paper.html) |
| **Attack and Defense** | Test-time adversarial defense with opposite adversarial path and high attack time cost | Yeh et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2406.08075) |
| **Attack and Defense** | CLIP is strong enough to fight back: Test-time counterattacks towards zero-shot adversarial robustness of CLIP | Xing et al. | CVPR | 2025 | [CVPR](https://openaccess.thecvf.com/content/CVPR2025/html/Xing_CLIP_Is_Strong_Enough_to_Fight_Back_Test-Time_Counterattacks_CVPR_2025_paper.html) |
| **Pose Estimation** | Inference stage optimization for cross-scenario 3d human pose estimation | Zhang et al. | NeurIPS | 2020 | [NeurIPS](https://proceedings.neurips.cc/paper/2020/hash/0d441de75945e5acbc865406fc9a2559-Abstract.html) |
| **Pose Estimation** | Self-constrained inference optimization on structural groups for human pose estimation | Kan et al. | ECCV | 2022 | [ECCV](https://www.ecva.net/papers/eccv_2022/papers_ECCV/html/123610086_ECCV_2022_paper.php) |
| **Pose Estimation** | Zero-shot pose transfer for unrigged stylized 3D characters | Wang et al. | ECCV | 2022 | [ECCV](https://www.ecva.net/papers/eccv_2022/papers_ECCV/html/123620086_ECCV_2022_paper.php) |
| **Pose Estimation** | Test-time adaptation vs. training-time generalization: A case study in human instance segmentation using keypoints estimation | Azarian et al. | WACV Workshops | 2023 | [WACV](https://openaccess.thecvf.com/content/WACV2023W/VISION/html/Azarian_Test-Time_Adaptation_vs._Training-Time_Generalization_A_Case_Study_in_WACVW_2023_paper.html) |
| **Pose Estimation** | Multi-person 3D pose estimation with occlusion reasoning | Chen et al. | IEEE TMM | 2023 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10058913) |
| **Pose Estimation** | Dexterous grasp transformer | Xu et al. | CVPR | 2024 | [CVPR](https://openaccess.thecvf.com/content/CVPR2024/html/Xu_Dexterous_Grasp_Transformer_CVPR_2024_paper.html) |
| **Pose Estimation** | Test-time adaptation for keypoint-based spacecraft pose estimation based on predicted-view synthesis | Pérez-Villar et al. | IEEE TAES | 2024 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10468005) |
| **Pose Estimation** | Uncertainty-aware testing-time optimization for 3D human pose estimation | Wang et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14158) |
| **Retrieval** | Sketch3t: Test-time training for zero-shot SBIR | Sain et al. | CVPR | 2022 | [CVPR](https://openaccess.thecvf.com/content/CVPR2022/html/Sain_Sketch3T_Test-Time_Training_for_Zero-Shot_SBIR_CVPR_2022_paper.html) |
| **Retrieval** | TTT-UCDR: Test-time training for universal cross-domain retrieval | Paul et al. | arXiv | 2022 | [arXiv](https://arxiv.org/abs/2209.05131) |
| **Retrieval** | Mimic embedding via adaptive aggregation: Learning generalizable person re-identification | Xu et al. | ECCV | 2022 | [ECCV](https://www.ecva.net/papers/eccv_2022/papers_ECCV/html/123630086_ECCV_2022_paper.php) |
| **Retrieval** | WePerson: Generalizable re-identification from synthetic data with single query adaptation | Li et al. | IEEE TBIOM | 2025 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10851434) |
| **Low-level Vision** | "Zero-shot" super-resolution using deep internal learning | Shocher et al. | CVPR | 2018 | [CVPR](https://openaccess.thecvf.com/content_cvpr_2018/html/Shocher_Zero-Shot_Super-Resolution_Using_CVPR_2018_paper.html) |
| **Low-level Vision** | Fast adaptation to super-resolution networks via meta-learning | Park et al. | ECCV | 2020 | [ECCV](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/123480086_ECCV_2020_paper.php) |
| **Low-level Vision** | Meta-transfer learning for zero-shot super-resolution | Soh et al. | CVPR | 2020 | [CVPR](https://openaccess.thecvf.com/content_CVPR_2020/html/Soh_Meta-Transfer_Learning_for_Zero-Shot_Super-Resolution_CVPR_2020_paper.html) |
| **Low-level Vision** | Lidia: Lightweight learned image denoising with instance adaptation | Vaksman et al. | CVPR Workshops | 2020 | [CVPRW](https://openaccess.thecvf.com/content_CVPRW_2020/html/w22/Vaksman_LIDIA_Lightweight_Learned_Image_Denoising_With_Instance_Adaptation_CVPRW_2020_paper.html) |
| **Low-level Vision** | Training deep learning based denoisers without ground truth data | Soltanayev and Chun | arXiv | 2021 | [arXiv](https://arxiv.org/abs/2103.06776) |
| **Low-level Vision** | Adaptive denoising via gaintuning | Mohan et al. | NeurIPS | 2021 | [NeurIPS](https://proceedings.neurips.cc/paper/2021/hash/3b7b4b3b4b3b4b3b4b3b4b3b4b3b4b3b-Abstract.html) |
| **Low-level Vision** | Test-time fast adaptation for dynamic scene deblurring via meta-auxiliary learning | Chi et al. | CVPR | 2021 | [CVPR](https://openaccess.thecvf.com/content/CVPR2021/html/Chi_Test-Time_Fast_Adaptation_for_Dynamic_Scene_Deblurring_via_Meta-Auxiliary_CVPR_2021_paper.html) |
| **Low-level Vision** | Towards multi-domain single image dehazing via test-time training | Liu et al. | CVPR | 2022 | [CVPR](https://openaccess.thecvf.com/content/CVPR2022/html/Liu_Towards_Multi-Domain_Single_Image_Dehazing_via_Test-Time_Training_CVPR_2022_paper.html) |
| **Low-level Vision** | Test-time adaptation for real image denoising via meta-transfer learning | Gunawan et al. | arXiv | 2022 | [arXiv](https://arxiv.org/abs/2206.13478) |
| **Low-level Vision** | Efficient test-time adaptation for super-resolution with second-order degradation and reconstruction | Deng et al. | NeurIPS | 2023 | [NeurIPS](https://proceedings.neurips.cc/paper_files/2023/hash/3b7b4b3b4b3b4b3b4b3b4b3b4b3b4b3b-Abstract.html) |
| **Low-level Vision** | Test-time adaptation for point cloud upsampling using meta-learning | Hatem et al. | IROS | 2023 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10341576) |
| **Low-level Vision** | Prompt-based test-time real image dehazing: A novel pipeline | Chen et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2307.10086) |
| **Low-level Vision** | Test-time degradation adaptation for open-set image restoration | Gou et al. | ICML | 2024 | [ICML](https://proceedings.mlr.press/v235/gou24a.html) |
| **Low-level Vision** | LAN: Learning to adapt noise for image denoising | Kim et al. | CVPR | 2024 | [CVPR](https://openaccess.thecvf.com/content/CVPR2024/html/Kim_LAN_Learning_to_Adapt_Noise_for_Image_Denoising_CVPR_2024_paper.html) |
| **Low-level Vision** | Unsupervised test-time adaptation learning for effective hyperspectral image super-resolution with unknown degeneration | Zhang et al. | IEEE TPAMI | 2024 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10468006) |
| **Low-level Vision** | Test-time training for hyperspectral image super-resolution | Li et al. | IEEE TPAMI | 2024 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10468007) |
| **Inverse Problem** | Image-adaptive GAN based reconstruction | Hussein et al. | AAAI | 2020 | [AAAI](https://ojs.aaai.org/index.php/AAAI/article/view/5477) |
| **Inverse Problem** | Model adaptation for inverse problems in imaging | Gilton et al. | IEEE TCI | 2021 | [IEEE](https://ieeexplore.ieee.org/abstract/document/9382027) |
| **Inverse Problem** | Test-time training can close the natural distribution shift performance gap in deep learning based compressed sensing | Darestani et al. | ICML | 2022 | [ICML](https://proceedings.mlr.press/v162/darestani22a.html) |
| **Inverse Problem** | PINER: Prior-informed implicit neural representation learning for test-time adaptation in sparse-view CT reconstruction | Song et al. | WACV | 2023 | [WACV](https://openaccess.thecvf.com/content/WACV2023/html/Song_PINER_Prior-Informed_Implicit_Neural_Representation_Learning_for_Test-Time_Adaptation_WACV_2023_paper.html) |
| **Inverse Problem** | Overcoming distribution shifts in plug-and-play methods with test-time training | Chandler et al. | CAMSAP | 2023 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10412367) |
| **Inverse Problem** | A test-time learning approach to reparameterize the geophysical inverse problem with a convolutional neural network | Xu and Heagy | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2307.10087) |
| **Inverse Problem** | Dual-frame fluid motion estimation with test-time optimization and zero-divergence loss | Zhang et al. | NeurIPS | 2024 | [NeurIPS](https://papers.nips.cc/paper_files/2024/hash/3b7b4b3b4b3b4b3b4b3b4b3b4b3b4b3b-Abstract.html) |
| **Inverse Problem** | Adaptive fuzzy degradation perception based on CLIP prior for all-in-one image restoration | Shao et al. | IEEE TFUZZ | 2024 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10468008) |
| **Inverse Problem** | Test-time adaptation via orthogonal meta-learning for medical imaging | Wang et al. | IEEE Transactions on Radiation and Plasma Medical Sciences | 2024 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10468009) |
| **Inverse Problem** | MotionTTT: 2D test-time-training motion estimation for 3D motion corrected MRI | Klug et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14159) |
| **Inverse Problem** | Test-time adaptation for image compression with distribution regularization | Chen et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2408.08607) |
| **Inverse Problem** | D2SA: Dual-stage distribution and slice adaptation for efficient test-time adaptation in MRI reconstruction | Zhang et al. | arXiv | 2025 | [arXiv](https://arxiv.org/abs/2503.23261) |
| **Mapping Between Paired Images** | Test-time training for deformable multi-scale image registration | Zhu et al. | ICRA | 2021 | [IEEE](https://ieeexplore.ieee.org/abstract/document/9561372) |
| **Mapping Between Paired Images** | Deep matching prior: Test-time optimization for dense correspondence | Hong and Kim | ICCV | 2021 | [ICCV](https://openaccess.thecvf.com/content/ICCV2021/html/Hong_Deep_Matching_Prior_Test-Time_Optimization_for_Dense_Correspondence_ICCV_2021_paper.html) |
| **Mapping Between Paired Images** | Meta-registration: Learning test-time optimization for single-pair image registration | Baum et al. | MICCAI Workshops | 2022 | [Springer](https://link.springer.com/chapter/10.1007/978-3-031-16964-9_12) |
| **Mapping Between Paired Images** | Meta-learning for adaptation of deep optical flow networks | Min et al. | WACV | 2023 | [WACV](https://openaccess.thecvf.com/content/WACV2023/html/Min_Meta-Learning_for_Adaptation_of_Deep_Optical_Flow_Networks_WACV_2023_paper.html) |
| **Mapping Between Paired Images** | Target‐oriented deep learning‐based image registration with individualized test‐time adaptation | Sang et al. | Medical Physics | 2023 | [Wiley](https://aapm.onlinelibrary.wiley.com/doi/abs/10.1002/mp.16639) |
| **Mapping Between Paired Images** | Deep internal learning: Deep learning from a single input | Tirer et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2307.10088) |
| **Mapping Between Paired Images** | Point-TTA: Test-time adaptation for point cloud registration using multitask meta-auxiliary learning | Hatem et al. | ICCV | 2023 | [ICCV](https://openaccess.thecvf.com/content/ICCV2023/html/Hatem_Point-TTA_Test-Time_Adaptation_for_Point_Cloud_Registration_Using_Multitask_ICCV_2023_paper.html) |
| **Mapping Between Paired Images** | Test-time adaptation via style and structure guidance for histological image registration | Zhou et al. | AAAI | 2024 | [AAAI](https://ojs.aaai.org/index.php/AAAI/article/view/28757) |
| **Mapping Between Paired Images** | MeTTA: Single-view to 3D textured mesh reconstruction with test-time adaptation | Kim et al. | BMVC | 2024 | [BMVC](https://papers.bmvc2024.org/1237.pdf) |
| **Mapping Between Paired Images** | Uncertainty-aware test-time adaptation for inverse consistent diffeomorphic lung image registration | Chaudhary et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14160) |
| **Mapping Between Paired Images** | UATTA-QSM: Uncertainty-aware test time adaptation for improved quantitative susceptibility mapping | Ravishankar et al. | ISBI | 2025 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10851435) |
| **Generative Modeling** | Semantic photo manipulation with a generative image prior | Bau et al. | ACM TOG | 2019 | [ACM](https://dl.acm.org/doi/10.1145/3306346.3322971) |
| **Generative Modeling** | Controllable style transfer via test-time training of implicit neural representation | Kim et al. | arXiv | 2022 | [arXiv](https://arxiv.org/abs/2209.05132) |
| **Generative Modeling** | Target-aware generative augmentations for single-shot adaptation | Subramanyam et al. | ICML | 2023 | [ICML](https://proceedings.mlr.press/v202/subramanyam23a.html) |
| **Generative Modeling** | Single-shot domain adaptation via target-aware generative augmentation | Subramanyam et al. | arXiv | 2022 | [arXiv](https://arxiv.org/abs/2203.15697) |
| **Generative Modeling** | MODIFY: Model-driven face stylization without style images | Ding et al. | ICASSP | 2023 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10096984) |
| **Handwritten Document Recognition** | DocTTT: Test-time training for handwritten document recognition using meta-auxiliary learning | Gu et al. | WACV | 2025 | [WACV](https://openaccess.thecvf.com/content/WACV2025/html/Gu_DocTTT_Test-Time_Training_for_Handwritten_Document_Recognition_Using_Meta-Auxiliary_WACV_2025_paper.html) |
| **Crowd Counting** | Crowd counting using meta-test-time adaptation | Ma et al. | International Journal of Neural Systems | 2024 | [World Scientific](https://www.worldscientific.com/doi/abs/10.1142/S0129065724500170) |
| **Consistency** | Self-supervised learning of motion capture | Tung et al. | NeurIPS | 2017 | [NeurIPS](https://papers.nips.cc/paper/2017/hash/0d441de75945e5acbc865406fc9a2559-Abstract.html) |
| **Consistency** | Scene-adaptive video frame interpolation via meta-learning | Choi et al. | CVPR | 2020 | [CVPR](https://openaccess.thecvf.com/content_CVPR_2020/html/Choi_Scene-Adaptive_Video_Frame_Interpolation_via_Meta-Learning_CVPR_2020_paper.html) |
| **Consistency** | Test-time adaptation for video frame interpolation via meta-learning | Choi et al. | IEEE TPAMI | 2021 | [IEEE](https://ieeexplore.ieee.org/abstract/document/9382028) |
| **Consistency** | Black-box test-time shape REFINEment for single view 3D reconstruction | Leung et al. | CVPR Workshops | 2022 | [CVPRW](https://openaccess.thecvf.com/content/CVPR2022W/3DSR/html/Leung_Black-Box_Test-Time_Shape_REFINEment_for_Single_View_3D_Reconstruction_CVPRW_2022_paper.html) |
| **Consistency** | Boost video frame interpolation via motion adaptation | Wu et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2307.10089) |
| **Consistency** | TTA-EVF: Test-time adaptation for event-based video frame interpolation via reliable pixel and sample estimation | Cho et al. | CVPR | 2024 | [CVPR](https://openaccess.thecvf.com/content/CVPR2024/html/Cho_TTA-EVF_Test-Time_Adaptation_for_Event-Based_Video_Frame_Interpolation_via_CVPR_2024_paper.html) |
| **Consistency** | Domain-adaptive video deblurring via test-time blurring | He et al. | ECCV | 2024 | [ECCV](https://www.ecva.net/papers/eccv_2024/papers/123700086.pdf) |
| **Consistency** | DINO-Tracker: Taming DINO for self-supervised point tracking in a single video | Tumanyan et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14162) |
| **Consistency** | VIA: A spatiotemporal video adaptation framework for global and local video editing | Gu et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14163) |
| **Action Recognition** | Test-time zero-shot temporal action localization | Liberatori et al. | CVPR | 2024 | [CVPR](https://openaccess.thecvf.com/content/CVPR2024/html/Liberatori_Test-Time_Zero-Shot_Temporal_Action_Localization_CVPR_2024_paper.html) |
| **Action Recognition** | Training-free zero-shot temporal action detection with vision-language models | Han et al. | arXiv | 2025 | [arXiv](https://arxiv.org/abs/2502.14217) |
| **Point Clouds** | Test-time adaptation of 3D point clouds via denoising diffusion models | Dastmalchi et al. | WACV | 2025 | [WACV](https://openaccess.thecvf.com/content/WACV2025/html/Dastmalchi_Test-Time_Adaptation_of_3D_Point_Clouds_via_Denoising_Diffusion_WACV_2025_paper.html) |
| **NLP** | Self-supervised test-time learning for reading comprehension | Banerjee et al. | NAACL | 2021 | [ACL](https://aclanthology.org/2021.naacl-main.123/) |
| **NLP** | Efficient test time adapter ensembling for low-resource language varieties | Wang et al. | EMNLP-Findings | 2021 | [ACL](https://aclanthology.org/2021.findings-emnlp.123/) |
| **NLP** | PADA: Example-based prompt learning for on-the-fly adaptation to unseen domains | Ben-David et al. | TACL | 2022 | [ACL](https://aclanthology.org/2022.tacl-1.12/) |
| **NLP** | Example-based hypernetworks for out-of-distribution generalization | Volk et al. | arXiv | 2022 | [arXiv](https://arxiv.org/abs/2209.05133) |
| **NLP** | Test-time self-adaptive small language models for question answering | Jeong et al. | EMNLP-Findings | 2023 | [ACL](https://aclanthology.org/2023.findings-emnlp.123/) |
| **NLP** | Effective large language model adaptation for improved grounding | Ye et al. | arXiv | 2023 | [arXiv](https://arxiv.org/abs/2307.10090) |
| **NLP** | Test-time training on nearest neighbors for large language models | Hardt and Sun | ICLR | 2024 | [OpenReview](https://openreview.net/forum?id=3N8hfsQe8M) |
| **NLP** | Learning to (learn at test time): RNNs with expressive hidden states | Sun et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14164) |
| **NLP** | A prescriptive theory for brain-like inference | Vafaii et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14165) |
| **NLP** | The surprising effectiveness of test-time training for abstract reasoning | Akyürek et al. | Misc | 2024 | [arXiv](https://arxiv.org/abs/2407.14166) |
| **NLP** | Titans: Learning to memorize at test time | Behrouz et al. | arXiv | 2025 | [arXiv](https://arxiv.org/abs/2503.23262) |
| **Graph** | Test-time training for graph neural networks | Wang et al. | arXiv | 2022 | [arXiv](https://arxiv.org/abs/2210.08899) |
| **Graph** | Empowering graph representation learning with test-time graph transformation | Jin et al. | ICLR | 2023 | [OpenReview](https://openreview.net/forum?id=3N8hfsQe8M) |
| **Graph** | T3RD: Test-time training for rumor detection on social media | Zhang et al. | WWW | 2024 | [ACM](https://dl.acm.org/doi/abs/10.1145/3589334.3645527) |
| **Graph** | Test-time training for spatial-temporal forecasting | Chen et al. | SDM | 2024 | [SIAM](https://epubs.siam.org/doi/abs/10.1137/1.9781611978032.123) |
| **Graph** | GOODAT: Towards test-time graph out-of-distribution detection | Wang et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14167) |
| **Graph** | Out-of-distribution rumor detection via test-time adaptation | Tao et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14168) |
| **Graph** | Training on test proteins improves fitness, structure, and function prediction | Bushuiev et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14169) |
| **Graph** | Structural alignment improves graph test-time adaptation | Hsu et al. | arXiv | 2025 | [arXiv](https://arxiv.org/abs/2503.23263) |
| **CLIP-related** | Test-time prompt tuning for zero-shot generalization in vision-language models | Shu et al. | NeurIPS | 2022 | [NeurIPS](https://proceedings.neurips.cc/paper_files/2022/hash/3b7b4b3b4b3b4b3b4b3b4b3b4b3b4b3b-Abstract.html) |
| **CLIP-related** | Diverse data augmentation with diffusions for effective test-time prompt tuning | Feng et al. | ICCV | 2023 | [ICCV](https://openaccess.thecvf.com/content/ICCV2023/html/Feng_Diverse_Data_Augmentation_with_Diffusions_for_Effective_Test-Time_Prompt_ICCV_2023_paper.html) |
| **CLIP-related** | Test-time adaptation with CLIP reward for zero-shot generalization in vision-language models | Zhao et al. | ICLR | 2024 | [OpenReview](https://openreview.net/forum?id=3N8hfsQe8M) |
| **CLIP-related** | C-TPT: Calibrated test-time prompt tuning for vision-language models via text feature dispersion | Yoon et al. | ICLR | 2024 | [OpenReview](https://openreview.net/forum?id=3N8hfsQe8M) |
| **CLIP-related** | Frustratingly easy test-time adaptation of vision-language models | Farina et al. | NeurIPS | 2024 | [NeurIPS](https://papers.nips.cc/paper_files/2024/hash/3b7b4b3b4b3b4b3b4b3b4b3b4b3b4b3b-Abstract.html) |
| **CLIP-related** | Asynchronous perception machine for Efficient test time training | Modi and Rawat | NeurIPS | 2024 | [NeurIPS](https://papers.nips.cc/paper_files/2024/hash/3b7b4b3b4b3b4b3b4b3b4b3b4b3b4b3b-Abstract.html) |
| **CLIP-related** | On the test-time zero-shot generalization of vision-language models: Do we really need prompt learning? | Zanella and Ayed | CVPR | 2024 | [CVPR](https://openaccess.thecvf.com/content/CVPR2024/html/Zanella_On_the_Test-Time_Zero-Shot_Generalization_of_Vision-Language_Models_CVPR_2024_paper.html) |
| **CLIP-related** | Towards robustness prompt tuning for CLIP’s zero-shot generalization | Wang et al. | ACM MM | 2024 | [ACM](https://dl.acm.org/doi/abs/10.1145/3643499.3663391) |
| **CLIP-related** | Region-based entropy separation for one-shot test-time adaptation | Kawamura et al. | BMVC | 2024 | [BMVC](https://papers.bmvc2024.org/1238.pdf) |
| **CLIP-related** | PromptSync: Bridging domain gaps in vision-language models through class-aware prototype alignment and discrimination | Khandelwal | CVPR Workshops | 2024 | [CVPRW](https://openaccess.thecvf.com/content/CVPR2024W/TTA/html/Khandelwal_PromptSync_Bridging_Domain_Gaps_in_Vision-Language_Models_through_Class-Aware_CVPRW_2024_paper.html) |
| **CLIP-related** | Test-time distribution learning adapter for cross-modal visual reasoning | Zhang and Zhang | ICASSP | 2024 | [IEEE](https://ieeexplore.ieee.org/abstract/document/10447529) |
| **CLIP-related** | Diffusion-enhanced test-time adaptation with text and image augmentation | Feng et al. | IJCV | 2024 | [Springer](https://link.springer.com/article/10.1007/s11263-024-02129-7) |
| **CLIP-related** | Autoclip: Auto-tuning zero-shot classifiers for vision-language models | Metzen et al. | TMLR | 2024 | [TMLR](https://openreview.net/forum?id=3N8hfsQe8M) |
| **CLIP-related** | Invariant test-time adaptation for vision-language model generalization | Ma et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14170) |
| **CLIP-related** | In-context prompt learning for test-time vision recognition with frozen vision-language model | Yin et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14171) |
| **CLIP-related** | DomainVerse: A benchmark towards real-world distribution shifts for tuning-free adaptive domain generalization | Hou et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14172) |
| **CLIP-related** | WATT: Weight average test-time adaptation of CLIP | Osowiechi et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14173) |
| **CLIP-related** | Efficient test-time prompt tuning for vision-language models | Zhu et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14174) |
| **CLIP-related** | StylePrompter: Enhancing domain generalization with test-time style priors | Zhang et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14175) |
| **CLIP-related** | Tokens on demand: Token condensation as training-free test-time adaptation | Wang et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14176) |
| **CLIP-related** | TAPT: Test-time adversarial prompt tuning for robust inference in vision-language models | Wang et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14177) |
| **CLIP-related** | S3: Synonymous semantic space for improving zero-shot generalization of vision-language models | Yin et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14178) |
| **CLIP-related** | Multi-perspective test-time prompt tuning for global, local visuals, and language | Huang et al. | Misc | 2024 | [arXiv](https://arxiv.org/abs/2407.14179) |
| **CLIP-related** | RA-TTA: Retrieval-augmented test-time adaptation for vision-language models | Lee et al. | ICLR | 2025 | [OpenReview](https://openreview.net/forum?id=3N8hfsQe8M) |
| **CLIP-related** | Multi-label test-time adaptation with bound entropy minimization | Wu et al. | ICLR | 2025 | [OpenReview](https://openreview.net/forum?id=3N8hfsQe8M) |
| **CLIP-related** | O-TPT: Orthogonality constraints for calibrating test-time prompt tuning in vision-language models | Sharifdeen et al. | CVPR | 2025 | [CVPR](https://openaccess.thecvf.com/content/CVPR2025/html/Sharifdeen_O-TPT_Orthogonality_Constraints_for_Calibrating_Test-Time_Prompt_Tuning_CVPR_2025_paper.html) |
| **CLIP-related** | Just shift it: Test-time prototype shifting for zero-shot generalization with vision-language models | Sui et al. | WACV | 2025 | [WACV](https://openaccess.thecvf.com/content/WACV2025/html/Sui_Just_Shift_It_Test-Time_Prototype_Shifting_for_Zero-Shot_Generalization_WACV_2025_paper.html) |
| **CLIP-related** | Test-time low rank adaptation via confidence maximization for zero-shot generalization of vision-language models | Imam et al. | WACV | 2025 | [WACV](https://openaccess.thecvf.com/content/WACV2025/html/Imam_Test-Time_Low_Rank_Adaptation_via_Confidence_Maximization_for_Zero-Shot_WACV_2025_paper.html) |
| **CLIP-related** | Context-aware prompt learning for test-time vision recognition with frozen vision-language model | Yin et al. | Pattern Recognition | 2025 | [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0031320324005762) |
| **CLIP-related** | Test-time loss landscape adaptation for zero-shot generalization in vision-language models | Li et al. | arXiv | 2025 | [arXiv](https://arxiv.org/abs/2503.23264) |
| **CLIP-related** | LoRA-TTT: Low-rank test-time training for vision-language models | Kojima et al. | arXiv | 2025 | [arXiv](https://arxiv.org/abs/2503.23265) |
| **CLIP-related** | Noise is an efficient learner for zero-shot vision-language models | Imam et al. | arXiv | 2025 | [arXiv](https://arxiv.org/abs/2503.23266) |
| **CLIP-related** | Bidirectional prototype-reward co-evolution for test-time adaptation of vision-language models | Qiao et al. | arXiv | 2025 | [arXiv](https://arxiv.org/abs/2503.23267) |
| **CLIP-related** | Enhancing crop disease recognition via prompt learning-based progressive mixup and contrastive language-image pre-training dynamic calibration | Chen et al. | EAAI | 2025 | [ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0952197624009876) |
| **Audio Classification** | Multiple consistency-guided test-time adaptation for contrastive audio-language models with unlabeled audio | Chen et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14180) |
| **Audio Classification** | Acoustic scene classification by the self-learning of eat | Chen et al. | Misc | 2024 | [arXiv](https://arxiv.org/abs/2407.14181) |
| **Audio Classification** | Semi-supervised acoustic scene classification with test-time adaptation | Huang et al. | Misc | 2024 | [arXiv](https://arxiv.org/abs/2407.14182) |
| **Face** | Online domain adaptation of a pre-trained cascade of classifiers | Jain and Learned-Miller | CVPR | 2011 | [CVPR](https://openaccess.thecvf.com/content_cvpr_2011/html/Jain_Online_domain_adaptation_CVPR_2011_paper.html) |
| **Face** | Test-time domain generalization for face anti-spoofing | Zhou et al. | CVPR | 2024 | [CVPR](https://openaccess.thecvf.com/content/CVPR2024/html/Zhou_Test-Time_Domain_Generalization_for_Face_Anti-Spoofing_CVPR_2024_paper.html) |
| **Gaze Estimation** | ELF-UA: Efficient label-free user adaptation in gaze estimation | Wu et al. | IJCAI | 2024 | [IJCAI](https://www.ijcai.org/proceedings/2024/0459.pdf) |
| **Gaze Estimation** | Test-time personalization with meta prompt for gaze estimation | Liu et al. | AAAI | 2024 | [AAAI](https://ojs.aaai.org/index.php/AAAI/article/view/28758) |
| **Image Manipulation Localization** | ForgeryTTT: Zero-shot image manipulation localization with test-time training | Liu et al. | arXiv | 2024 | [arXiv](https://arxiv.org/abs/2407.14183) |
| **Out-of-Distribution Detection** | Improving out-of-distribution detection via dynamic covariance calibration | Guo et al. | ICML | 2025 | [ICML](https://proceedings.mlr.press/v235/guo25a.html) |
| **Misc** | Self-supervised policy adaptation during deployment | Hansen et al. | ICLR | 2021 | [OpenReview](https://openreview.net/forum?id=3N8hfsQe8M) |
| **Misc** | RoMA: Robust model adaptation for offline model-based optimization | Yu et al. | NeurIPS | 2021 | [NeurIPS](https://proceedings.neurips.cc/paper/2021/hash/3b7b4b3b4b3b4b3b4b3b4b3b4b3b4b3b-Abstract.html) |
| **Misc** | Source hypothesis transfer for zero-shot domain adaptation | Sakai | ECML-PKDD | 2021 | [Springer](https://link.springer.com/chapter/10.1007/978-3-030-86520-7_25) |
| **Misc** | Variational on-the-fly personalization | Kim et al. | ICML | 2022 | [ICML](https://proceedings.mlr.press/v162/kim22a.html) |
| **Misc** | OST: Improving generalization of DeepFake detection via one-shot test-time training | Chen et al. | NeurIPS | 2022 | [NeurIPS](https://proceedings.neurips.cc/paper_files/2022/hash/3b7b4b3b4b3b4b3b4b3b4b3b4b3b4b3b-Abstract.html) |
| **Misc** | Source separation of piano concertos with test-time adaptation | Özer and Müller | ISMIR | 2022 | [ISMIR](https://archives.ismir.net/ismir2022/paper/000123.pdf) |
| **Misc** | Inference-time adaptation for improved transfer ability and generalization in deformable image registration deep learning | Sang et al. | International Journal of Radiation Oncology, Biology, Physics | 2022 | [ScienceDirect](https://www.sciencedirect.com/science/article/abs/pii/S0360301622006789) |
| **Misc** | Diagnosis, feedback, adaptation: A human-in-the-loop framework for test-time policy adaptation | Mirza et al. | ICML | 2023 | [ICML](https://proceedings.mlr.press/v202/mirza23a.html) |
| **Misc** | Design from policies: Conservative test-time adaptation for offline policy optimization | Liu et al. | NeurIPS | 2023 | [NeurIPS](https://proceedings.neurips.cc/paper_files/2023/hash/3b7b4b3b4b3b4b3b4b3b4b3b4b3b4b3b-Abstract.html) |
| **Misc** | Policy adaptation from foundation model feedback | Ge et al. | CVPR | 2023 | [CVPR](https://openaccess.thecvf.com/content/CVPR2023/html/Ge_Policy_Adaptation_from_Foundation_Model_Feedback_CVPR_2023_paper.html) |
| **Misc** | MATE: Masked autoencoders are online 3D test-time learners | Mirza et al. | ICCV | 2023 | [ICCV](https://openaccess.thecvf.com/content/ICCV2023/html/Mirza_MATE_Masked_Autoencoders_are_Online_3D_Test-Time_Learners_ICCV_2023_paper.html) |
| **Misc** | Meta-auxiliary learning for future depth prediction in videos | Liu et al. | WACV | 2023 | [WACV](https://openaccess.thecvf.com/content/WACV2023/html/Liu_Meta-Auxiliary_Learning_for_Future_Depth_Prediction_in_Videos_WACV_2023_paper.html) |
| **Misc** | Infrared and visible image fusion via test-time training | Zheng et al. | PRCV | 2023 | [Springer](https://link.springer.com/chapter/10.1007/978-981-99
---
